...
def get_data(
    start_user_id, end_user_id, get_path="http://jsonplaceholder.typicode.com/posts" #cambiar el path
):
    http = urllib3.PoolManager()
    data = {"userId": None, "id": None, "title": None, "body": None} #modificar columnas
    try:
        r = http.request(
            "GET",
            get_path,
            retries=urllib3.util.Retry(3),
            fields={"start_user_id": start_user_id, "end_user_id": end_user_id}, #modificar fields
        )
